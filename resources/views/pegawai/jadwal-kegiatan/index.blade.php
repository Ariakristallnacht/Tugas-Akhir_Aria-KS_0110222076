...
@php
    $title = 'Jadwal Kegiatan Pegawai | Puskesmas Bunar';
    ...
    <section class="pkm-dashboard-main pkm-dashboard-main--pegawai-jadwal">
        ...
        <div class="pkm-management-summary">
            <article class="pkm-metric-card">
                ...
                <div class="pkm-metric-card__label">Total Agenda</div>
            </article>
            <article class="pkm-metric-card">
                ...
                <section class="pkm-card">
                    ...
                    <form method="GET" action="{{ route('pegawai.jadwal-kegiatan') }}" class="pkm-monitoring-filter">
                        ...
                        <div class="pkm-form-actions">
                            <a href="{{ route('pegawai.jadwal-kegiatan') }}" class="pkm-secondary-button"><span>Reset</span></a>
