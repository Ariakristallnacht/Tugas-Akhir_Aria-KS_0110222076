...
@push('styles')
    <style>
        .pkm-dashboard-main--pegawai-laporan {
            display: flex;
...
@section('content')
    <section class="pkm-dashboard-main pkm-dashboard-main--pegawai-laporan">
        ...
        <section class="pkm-card">
            ...
            <form method="GET" action="{{ route('pegawai.laporan-kegiatan.index') }}" class="pkm-monitoring-filter">
                ...
                <div class="pkm-form-actions">
                    <a href="{{ route('pegawai.laporan-kegiatan.index') }}" class="pkm-secondary-button"><span>Reset</span></a>
