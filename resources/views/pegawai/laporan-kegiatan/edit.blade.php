    ...
    <section class="pkm-dashboard-main">
        <div class="pkm-card pkm-form-card">
            <div class="pkm-card__head">
                <div>
                    <h2 style="font-weight: bold">Edit Laporan Kegiatan</h2>
                </div>
            </div>

            @include('admin.partials.flash')

            <form method="POST" action="{{ route('pegawai.laporan-kegiatan.update', $report) }}" class="pkm-form-stack" enctype="multipart/form-data">
                @csrf
                @method('PUT')
